        ...
        @if (sizeof(Cart::content()) > 0)
            ...
            <table class="table">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>
                            ...
                            <form action="{{ url('switchToWishlist', [$item->rowId]) }}" method="POST" class="side-by-side">
                                {!! csrf_field() !!}
                                <input type="submit" class="btn unique-color btn-sm" value="Move to Wishlist">
                            </form>
                        </td>
                    </tr>
                    ...
                    <tr class="border-bottom fade-in">
                        <td class="table-image"></td>
            ...
            <a href="{{ url('/shop') }}" class="btn unique-color btn-lg">Continue Shopping</a> &nbsp;
            <a href="#" class="btn warning-color btn-lg">Proceed to Checkout</a>
            ...
            <div style="float:right">
                <form action="{{ url('/emptyCart') }}" method="POST">
                    {!! csrf_field() !!}
                    <input type="hidden" name="_method" value="DELETE">
                    <input type="submit" class="btn stylish-color btn-lg" value="Empty Cart">
                </form>
            </div>
